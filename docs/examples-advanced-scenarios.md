...
Ниже собраны практические сквозные сценарии для электронной коммерции и программ лояльности.
...
Полная версия с правилами и ограничениями: [Практика: реферальная программа](howto-referral-program.md).
